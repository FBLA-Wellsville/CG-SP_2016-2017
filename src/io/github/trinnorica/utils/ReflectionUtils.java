...
public final class ReflectionUtils {
	...
	public static Object getPrivateField(String fieldName, String className, String path, Object instance) throws ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
		Field field;
		Object o = null;
	 ...
	 */
	public static Constructor<?> getConstructor(String className, String path, Class<?>... parameterTypes) throws NoSuchMethodException, ClassNotFoundException {
		return getConstructor(Class.forName(path + "." + className), parameterTypes);
	}
	 ...
	 */
	public static Object instantiateObject(String className, String path, Object... arguments) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException {
		return instantiateObject(Class.forName(path + "." + className), arguments);
	}
	 ...
	 */
	public static Method getMethod(String className, String path, String methodName, Class<?>... parameterTypes) throws NoSuchMethodException, ClassNotFoundException {
		return getMethod(Class.forName(path + "." + className), methodName, parameterTypes);
	}
	 ...
	 */
	public static Object invokeMethod(Object instance, String className, String path, String methodName, Object... arguments) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException {
		return invokeMethod(instance, Class.forName(path + "." + className), methodName, arguments);
	}
	 ...
	 */
	public static Field getField(String className, String path, boolean declared, String fieldName) throws NoSuchFieldException, SecurityException, ClassNotFoundException {
		return getField(Class.forName(path + "." + className), declared, fieldName);
	}
	 ...
	 */
	public static Object getValue(Object instance, String className, String path, boolean declared, String fieldName) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException, ClassNotFoundException {
		return getValue(instance, Class.forName(path + "." + className), declared, fieldName);
	}
	 ...
	 */
	public static void setValue(Object instance, String className, String path, boolean declared, String fieldName, Object value) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException, ClassNotFoundException {
		setValue(instance, Class.forName(path + "." + className), declared, fieldName, value);
	}
