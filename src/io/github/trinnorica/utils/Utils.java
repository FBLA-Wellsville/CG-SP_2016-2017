	...
	public static char[] getLevelBlueprint(int level) {
		...
		case 1:
			return new char[]{ 
					...
					'D','D','G','I','I','I','H','D','D','D','D','D','D','D','J','X','X','X','X','X','X','X','X','X','X','X','X','X','X','X','X','X',
					'D','D','E','X','X','X','F','D','D','D','D','D','D','D','D','J','X','X','X','X','X','X','X','X','X','X','X','X','X','X','X','X',
					'D','D','E','X','X','X','F','D','D','D','D','D','D','D','D','D','J','X','X','X','X','X','X','X','X','X','X','X','X','X','X','X',
					'D','D','E','X','X','X','F','D','D','D','D','D','D','D','D','D','D','J','X','X','X','X','X','X','X','X','X','X','X','X','X','X',
			};
		default: return null;
