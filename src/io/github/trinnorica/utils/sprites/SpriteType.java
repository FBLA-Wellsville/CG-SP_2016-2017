...
public enum SpriteType {
	...
	GRASS, STONE, FALLING_FLOOR, COMPETITOR, GATE, PLAYER, LADDER, WALL, GOLD, ARROW, BOW, NINJA_CLOAK, FALLING_WALL, SWITCH, TRIGGERED_SWITCH, KEY, DOOR, OPEN_DOOR, SPIKE, BOSS, BOOTS, BOX, CLOUD_BEGIN, CLOUD_MIDDLE, CLOUD_END, AIR, DIRT, FLOOR, CLOUD, DIRT_ARCH_DOWN, DYNAMIC_DIRT, TEST_ENTITY, OGRE, KNIGHT, DARK_KNIGHT, WIZARD, TOOL, STONE_SWORD, DARK_SWORD, STICK, SKELETON;
